...
public class AdminController {
	...
	static ArrayList<AdminBean> list = new ArrayList<>();
...
//				System.out.println(id + "  " + name + "  " + age + "  " + email + "  " + password);
				...
				adminDao.registerAdmin(id, name, email, password, age);
...
//				System.out.println(adminDao.getlogin());

				if (adminDao.getlogin() == true) {
					System.out.println();
				...
				while (flag == true) {
					if (adminDao.getlogin() == true) {
						...
						switch (ch) {
						case 1:
							adminDao.update(email, password);
						...
						case 3:
							...
							adminDao.delete(email, password);
							System.out.println();
						...
						case 5:
							...
							adminDao.getDataBetween(lower, upper);
							System.out.println();
							flag = true;
							break;
